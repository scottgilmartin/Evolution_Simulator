...
class Grid:
    ...
    def __init__(self, grid_size):
        ...
        self.img_grid = []  #a list of the individual avatar matrices which are stitched together to create the avatar layer of grid (img_grid_mat)
        self.dna_grid = []  #a list of the individual dna matrices from which the corresponding avatars above are drawn, used to create the dna layer of the grid (dna_grid_mat)
            ...
            for j in range(self.grid_size):
                for x in range(i * SPRITE_WIDTH, (i + 1) * SPRITE_WIDTH):
                    for y in range(j * SPRITE_HEIGHT, (j + 1) * SPRITE_HEIGHT):
                        ...
                        #stitch the individual sprites together by drawing them in the specified position in the grid matrices
