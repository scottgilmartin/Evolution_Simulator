...
# How does it work?
To simulate this, we generate sprites based on mutations of an original 'DNA' matrix. Then click the sprite that looks most like a face in each generation, 
the next generation will use the DNA of the selecion to generate similar mutations. 
In this way we can progressively make the sprite look more like a face with each generation.
